			...
			Windows: []tmux.Window{
				{
					...
					Active: true,
					Panes: []tmux.Pane{
						{ID: "%1", Index: 0, Command: "cms", WorkingDir: "/home/user/projects/cms", Active: false,
							Git: git.Info{IsRepo: true, Branch: "feature/refactor", RepoName: "cms", Dirty: true}},
						{ID: "%2", Index: 1, Command: "codex", WorkingDir: "/home/user/projects/cms", Active: true,
							Git: git.Info{IsRepo: true, Branch: "codex/functionality", RepoName: "cms"}},
						{ID: "%3", Index: 2, Command: "claude", WorkingDir: "/home/user/projects/cms", Active: false,
							Git: git.Info{IsRepo: true, Branch: "codex/functionality", RepoName: "cms"}},
					},
				},
			},
			...
			Windows: []tmux.Window{
				{
					...
					Active: true,
					Panes: []tmux.Pane{
						{ID: "%4", Index: 0, Command: "claude", WorkingDir: "/home/user/projects/gather_git", Active: true,
							Git: git.Info{IsRepo: true, Branch: "main", RepoName: "gather_git"}},
						{ID: "%5", Index: 1, Command: "zsh", WorkingDir: "/home/user/projects/gather_git", Active: false,
							Git: git.Info{IsRepo: true, Branch: "main", RepoName: "gather_git"}},
					},
				},
			},
